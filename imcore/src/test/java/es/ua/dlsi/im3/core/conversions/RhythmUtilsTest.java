    ...
    public void findRhythmForDuration() throws Exception {
        ...
        for (int dots=0; dots<2; dots++) {
            for (Figures figure: Figures.getFiguresSortedDesc(NotationType.eModern)) {
                List<RhythmUtils.FigureAndDots> result = RhythmUtils.findRhythmForDuration(NotationType.eModern, figure.getDurationWithDots(dots));
        ...
        List<RhythmUtils.FigureAndDots> result = RhythmUtils.findRhythmForDuration(NotationType.eModern, new Time(5));
        ...
        List<RhythmUtils.FigureAndDots> result2 = RhythmUtils.findRhythmForDuration(NotationType.eModern, new Time(5, 2));
