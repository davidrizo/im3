...
public class Rectangle extends Shape {
    ...
    public Rectangle(NotationSymbol notationSymbol, InteractionElementType interactionElementType, Coordinate from, Coordinate to)  {
        this(notationSymbol, interactionElementType, from, to, DEFAULT_THICKNESS, DEFAULT_STROKE_TYPE);
    }

    public Rectangle(NotationSymbol notationSymbol, InteractionElementType interactionElementType, Coordinate from, Coordinate to, double thickness, StrokeType strokeType) {
    ...
    public double getHeight() throws IM3Exception {
        return to.getAbsoluteY() - from.getAbsoluteY();
    }
