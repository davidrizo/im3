...
/**
 * It automatically moves elements to the required page and system
 */
public class AutomaticPageLayout extends PageLayout {
    ...
    public AutomaticPageLayout(ScoreSong song, Collection<Staff> staves, boolean includePageAndSystemBreaks, CoordinateComponent width, CoordinateComponent height) throws IM3Exception {
        super(song, staves);
