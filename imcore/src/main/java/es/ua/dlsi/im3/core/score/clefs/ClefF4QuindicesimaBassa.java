...
public class ClefF4QuindicesimaBassa extends Clef {
    ...
    public ClefF4QuindicesimaBassa() {
	//super(DiatonicPitch.F, 4, 1, 3, 2);
        //20180207 super(DiatonicPitch.F, 4, 1, 3, 2, -2);
        super(DiatonicPitch.F, 4, 1, -2,
    ...
    @Override
    public Clef clone() {
    		return new ClefF4QuindicesimaBassa();
    }
