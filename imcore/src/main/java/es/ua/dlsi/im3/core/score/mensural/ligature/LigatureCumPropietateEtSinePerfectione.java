 ...
 *
 */
public class LigatureCumPropietateEtSinePerfectione extends Ligature {

	public LigatureCumPropietateEtSinePerfectione(ScientificPitch firstPitch, int dotsFirstFigure, ScientificPitch secondPitch, int dotsSecondFigure, LigatureType ligatureType) {
