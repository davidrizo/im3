...
public class AgnosticExporterTest {
    void test(String filename, String expectedAgnostic, String expectedSemantic) throws IM3Exception {
        ...
        String agnosticStringFormat = new AgnosticExporter().export(encoder.getAgnosticEncoding());
