...
public class MEI2GraphicSymbolsTest {
    void test(String filename, String expected) throws IM3Exception {
    ...
    public void convertPrimusSampleWithAccidentalsAndFermata() throws Exception {
        ...
        test("/testdata/primus/000051806-1_1_1/000051806-1_1_1.mei", expected);
    }
    ...
    public void convertPrimusSampleBeams() throws Exception {
        ...
        test("/testdata/primus/000051759-1_1_1/000051759-1_1_1.mei", expected);
    }
    ...
    public void convertPrimusMultimeasure() throws Exception {
        ...
        test("/testdata/primus/000051650-1_1_2/000051650-1_1_2.mei", expected);
    }
    ...
    public void convertPrimusMultimeasureDoubleWholeGlyph() throws Exception {
        ...
        test("/testdata/primus/000051653-1_2_1/000051653-1_2_1.mei", expected);
    }
    ...
    public void convertPrimusAcciaccatura() throws Exception {
        ...
        test("/testdata/primus/000051660-1_2_1/000051660-1_2_1.mei", expected);
    }
    ...
    public void convertPrimusTrill() throws Exception {
        ...
        test("/testdata/primus/000100001-1_1_1/000100001-1_1_1.mei", expected);
    }
}