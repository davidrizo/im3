...
/**
 * @deprecated Use OMRSymbol
 * @param <SymbolType>
 */
public class OMRSymbolOLD<SymbolType> extends Group {
    ...
    public OMRSymbolOLD(Symbol<SymbolType> symbol, Color color) throws IM3Exception {
