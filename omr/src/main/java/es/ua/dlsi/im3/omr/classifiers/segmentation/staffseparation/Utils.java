...
public class Utils {
	/*public static void main(String [] args) {
		...
		Mat mInput = Highgui.imread("/home/jcalvo/Escritorio/perfect-nostaff.png",Highgui.IMREAD_GRAYSCALE);
		
		//Imgproc.erode(mInput, mInput, Imgproc.getStructuringElement(Imgproc.MORPH_RECT, new Size(3,4)));
		
		Highgui.imwrite("/home/jcalvo/Escritorio/perfect-nostaff.png",mInput);
		
		int [] rows = { 86, 104, 122, 140, 158 };
		
		for(int r: rows) {
			for(int i = 50; i <= 675; i++) {
				mInput.put(r-1, i, 0.0);
				mInput.put(r, i, 0.0);
				//mInput.put(r+1, i, 0.0);
			}
