...
public class SemanticFractionalTimeSignature extends SemanticTimeSignature<FractionalTimeSignature> {
    ...
    public SemanticFractionalTimeSignature(NotationType notationType, int num, int den) throws IM3Exception {
        super((FractionalTimeSignature) ImportFactories.processMeter(null, new Integer(num).toString(), new Integer(den).toString(), notationType));
    }
